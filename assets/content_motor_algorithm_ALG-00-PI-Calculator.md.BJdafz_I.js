import{_ as t,o as n,c as e,a4 as r}from"./chunks/framework.DAD9IEko.js";const d=JSON.parse('{"title":"电流环 PI 参数整定计算器","description":"","frontmatter":{"title":"电流环 PI 参数整定计算器","date":"2026-07-02T00:00:00.000Z","section":"电机控制","chapter":"algorithm","chapterTitle":"控制算法","category":"控制算法","tags":["imported"],"source":"motor","sourcePath":"algorithm/ALG-00-PI-Calculator.html","status":"learning","visibility":"public","summary":"Imported from algorithm/ALG-00-PI-Calculator.html","chapterOrder":20,"navGroup":"控制与算法","navGroupOrder":30},"headers":[],"relativePath":"content/motor/algorithm/ALG-00-PI-Calculator.md","filePath":"content/motor/algorithm/ALG-00-PI-Calculator.md","lastUpdated":1783181958000}'),o={name:"content/motor/algorithm/ALG-00-PI-Calculator.md"};function m(l,a,p,h,i,s){return n(),e("div",null,[...a[0]||(a[0]=[r(`<h1 id="电流环-pi-参数整定计算器" tabindex="-1">电流环 PI 参数整定计算器 <a class="header-anchor" href="#电流环-pi-参数整定计算器" aria-label="Permalink to &quot;电流环 PI 参数整定计算器&quot;">​</a></h1><p>基于极零对消法（Pole-Zero Cancellation）的一阶电流环PI调节器参数计算与可视化</p><pre><code> 电机电气参数输入
 ...
 不同 &amp;alpha; 值对比
</code></pre><div class="kb-table-scroll"><table><thead><tr><th>α (rad/s)</th><th>Kp (V/A)</th><th>Ki (V/(A·s))</th><th>τcl (ms)</th><th>上升时间 (ms)</th><th>带宽 (Hz)</th><th>安全性</th></tr></thead></table></div><pre><code> 频域 / 时域响应可视化
...
&amp;#8634; 恢复默认
</code></pre>`,8)])])}const u=t(o,[["render",m]]);export{d as __pageData,u as default};
