...
<span class="line"><span>- 电机转矩脉动大</span></span></code></pre></div></blockquote><h3 id="核心问题" tabindex="-1">核心问题 <a class="header-anchor" href="#核心问题" aria-label="Permalink to &quot;核心问题&quot;">​</a></h3><p>这些问题的根本原因是什么？</p><p><strong>答案</strong>：不理解IGBT的物理特性与MOSFET的差异！</p><ul><li>炸管 → 开关损耗叠加关断拖尾电流 → 结温远超计算值</li><li>损耗大 → IGBT在16kHz高频下Eoff占主导 → 频率与损耗非线性</li><li>死区畸变 → IGBT关断延迟2~3μs + 拖尾 → 有效死区远超配置值</li></ul><h3 id="学习目标" tabindex="-1">学习目标 <a class="header-anchor" href="#学习目标" aria-label="Permalink to &quot;学习目标&quot;">​</a></h3><p>读完本模块，你将能够：</p><p>✅ <strong>理解IGBT结构演进</strong> - NPT → PT → FS(Field Stop) → Trench-FS ✅ <strong>掌握IGBT静动态特性</strong> - 输出特性、转移特性、开关波形、拖尾电流 ✅ <strong>对比IGBT与MOSFET</strong> - 应用场景选择（电压/电流/频率三大维度） ✅ <strong>了解宽禁带器件</strong> - Si/SiC/GaN的性能边界与应用定位 ✅ <strong>掌握电机驱动选型</strong> - 电压等级、电流等级、开关频率、热设计的工程计算方法 ✅ <strong>理解IGBT模块封装</strong> - 从分立器件到IPM的演进路径</p><hr><h2 id="_3-💡-直观理解-★★★☆☆-🔰💡" tabindex="-1">3. 💡 直观理解 ★★★☆☆ 🔰💡 <a class="header-anchor" href="#_3-💡-直观理解-★★★☆☆-🔰💡" aria-label="Permalink to &quot;3. 💡 直观理解 ★★★☆☆ 🔰💡&quot;">​</a></h2><h3 id="类比1-igbt-电子阀-放大器-的混合体" tabindex="-1">类比1：IGBT = &quot;电子阀 + 放大器&quot;的混合体 <a class="header-anchor" href="#类比1-igbt-电子阀-放大器-的混合体" aria-label="Permalink to &quot;类比1：IGBT = &quot;电子阀 + 放大器&quot;的混合体&quot;">​</a></h3><p><strong>生活场景</strong>：想象一个水龙头（MOSFET栅极）控制一个高压水泵（BJT集电极）。</p>`,25)),p(n,{code:"flowchart%20LR%0A%20%20%20%20A%5B%22%E6%8E%A7%E5%88%B6%E4%BF%A1%E5%8F%B7(%E6%A0%85%E6%9E%81%E7%94%B5%E5%8E%8BVge)%22%5D%20--%3E%20B%5B%22MOSFET%E6%A0%85%E6%9E%81%22%5D%0A%20%20%20%20B%20--%3E%20C%5B%22BJT%E5%9F%BA%E6%9E%81%E7%94%B5%E6%B5%81%22%5D%0A%20%20%20%20C%20--%3E%20D%5B%22%E9%9B%86%E7%94%B5%E6%9E%81%E5%A4%A7%E7%94%B5%E6%B5%81%22%5D%0A"}),s[1]||(s[1]=a("p",null,[a("strong",null,"关键理解"),t("：")],-1)),s[2]||(s[2]=a("ul",null,[a("li",null,"栅极（Gate）像MOSFET，只需电压控制，输入阻抗极高"),a("li",null,"集电极-发射极（Collector-Emitter）像BJT，导通时有固定的饱和压降"),a("li",null,"输入端是MOS，输出端是BJT，两者在芯片内部级联")],-1)),s[3]||(s[3]=a("h3",{id:"类比2-拖尾电流就像-关门后还在滴水的水龙头",tabindex:"-1"},[t('类比2：拖尾电流就像"关门后还在滴水的水龙头" '),a("a",{class:"header-anchor",href:"#类比2-拖尾电流就像-关门后还在滴水的水龙头","aria-label":'Permalink to "类比2：拖尾电流就像"关门后还在滴水的水龙头""'},"​")],-1)),p(n,{code:"flowchart%20LR%0A%20%20%20%20A%5B%22%E5%85%B3%E6%96%AD%E6%8C%87%E4%BB%A4%22%5D%20--%3E%20B%5B%22%E6%A0%85%E6%9E%81%E6%94%BE%E7%94%B5%22%5D%0A%20%20%20%20B%20--%3E%20C%5B%22MOSFET%E6%B2%9F%E9%81%93%E5%85%B3%E9%97%AD%22%5D%0A%20%20%20%20C%20--%3E%20D%5B%22BJT%E5%B0%91%E5%AD%90%E5%A4%8D%E5%90%88%22%5D%0A%20%20%20%20D%20--%3E%20E%5B%22%E7%94%B5%E6%B5%81%E5%BD%92%E9%9B%B6%22%5D%0A"}),s[4]||(s[4]=e('<p><strong>生活场景</strong>：拧紧水龙头后，水管里残留的水还会流一会儿。IGBT关断时，BJT基区存储的少数载流子需要时间复合消失，这期间电流无法立即归零 → 产生可观的关断损耗。</p><h3 id="类比3-igbt-vs-mosfet-卡车-vs-跑车" tabindex="-1">类比3：IGBT vs MOSFET = 卡车 vs 跑车 <a class="header-anchor" href="#类比3-igbt-vs-mosfet-卡车-vs-跑车" aria-label="Permalink to &quot;类比3：IGBT vs MOSFET = 卡车 vs 跑车&quot;">​</a></h3><table tabindex="0"><thead><tr><th>特性</th><th>MOSFET（跑车）</th><th>IGBT（卡车）</th></tr></thead><tbody><tr><td>导通机制</td><td>单极性（多数载流子）</td><td>双极性（多数+少数载流子）</td></tr><tr><td>导通压降</td><td>电阻性，<span class="katex"><span class="katex-mathml"><math><semantics><mrow><msub><mi>R</mi><mrow><mi>D</mi><mi>S</mi><mo>(</mo><mi>o</mi><mi>n</mi><mo>)</mo></mrow></msub></mrow><annotation encoding="application/x-tex">R_{DS(on)}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="strut" style="height:0.68333em;"></span><span class="strut bottom" style="height:1.03853em;vertical-align:-0.3551999999999999em;"></span><span class="base textstyle uncramped"><span class="mord"><span class="mord mathit" style="margin-right:0.00773em;">R</span><span class="vlist"><span style="top:0.18019999999999992em;margin-right:0.05em;margin-left:-0.00773em;"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span><span class="reset-textstyle scriptstyle cramped"><span class="mord scriptstyle cramped"><span class="mord mathit" style="margin-right:0.02778em;">D</span><span class="mord mathit" style="margin-right:0.05764em;">S</span><span class="mopen">(</span><span class="mord mathit">o</span><span class="mord mathit">n</span><span class="mclose">)</span></span></span></span><span class="baseline-fix"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span>​</span></span></span></span></span></span></td><td>固定压降 <span class="katex"><span class="katex-mathml"><math><semantics><mrow><msub><mi>V</mi><mrow><mi>C</mi><mi>E</mi><mo>(</mo><mi>s</mi><mi>a</mi><mi>t</mi><mo>)</mo></mrow></msub></mrow><annotation encoding="application/x-tex">V_{CE(sat)}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="strut" style="height:0.68333em;"></span><span class="strut bottom" style="height:1.03853em;vertical-align:-0.3551999999999999em;"></span><span class="base textstyle uncramped"><span class="mord"><span class="mord mathit" style="margin-right:0.22222em;">V</span><span class="vlist"><span style="top:0.18019999999999992em;margin-right:0.05em;margin-left:-0.22222em;"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span><span class="reset-textstyle scriptstyle cramped"><span class="mord scriptstyle cramped"><span class="mord mathit" style="margin-right:0.07153em;">C</span><span class="mord mathit" style="margin-right:0.05764em;">E</span><span class="mopen">(</span><span class="mord mathit">s</span><span class="mord mathit">a</span><span class="mord mathit">t</span><span class="mclose">)</span></span></span></span><span class="baseline-fix"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span>​</span></span></span></span></span></span> + 电阻分量</td></tr><tr><td>高压特性</td><td><span class="katex"><span class="katex-mathml"><math><semantics><mrow><msub><mi>R</mi><mrow><mi>D</mi><mi>S</mi><mo>(</mo><mi>o</mi><mi>n</mi><mo>)</mo></mrow></msub><mo>∝</mo><msubsup><mi>V</mi><mrow><mi>D</mi><mi>S</mi></mrow><mn>2</mn></msubsup></mrow><annotation encoding="application/x-tex">R_{DS(on)} \\propto V_{DS}^2</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="strut" style="height:0.8141079999999999em;"></span><span class="strut bottom" style="height:1.1693079999999998em;vertical-align:-0.3551999999999999em;"></span><span class="base textstyle uncramped"><span class="mord"><span class="mord mathit" style="margin-right:0.00773em;">R</span><span class="vlist"><span style="top:0.18019999999999992em;margin-right:0.05em;margin-left:-0.00773em;"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span><span class="reset-textstyle scriptstyle cramped"><span class="mord scriptstyle cramped"><span class="mord mathit" style="margin-right:0.02778em;">D</span><span class="mord mathit" style="margin-right:0.05764em;">S</span><span class="mopen">(</span><span class="mord mathit">o</span><span class="mord mathit">n</span><span class="mclose">)</span></span></span></span><span class="baseline-fix"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span>​</span></span></span><span class="mrel">∝</span><span class="mord"><span class="mord mathit" style="margin-right:0.22222em;">V</span><span class="vlist"><span style="top:0.275331em;margin-left:-0.22222em;margin-right:0.05em;"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span><span class="reset-textstyle scriptstyle cramped"><span class="mord scriptstyle cramped"><span class="mord mathit" style="margin-right:0.02778em;">D</span><span class="mord mathit" style="margin-right:0.05764em;">S</span></span></span></span><span style="top:-0.363em;margin-right:0.05em;"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span><span class="reset-textstyle scriptstyle uncramped"><span class="mord mathrm">2</span></span></span><span class="baseline-fix"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span>​</span></span></span></span></span></span>（高压时电阻急剧增大）</td><td><span class="katex"><span class="katex-mathml"><math><semantics><mrow><msub><mi>V</mi><mrow><mi>C</mi><mi>E</mi><mo>(</mo><mi>s</mi><mi>a</mi><mi>t</mi><mo>)</mo></mrow></msub></mrow><annotation encoding="application/x-tex">V_{CE(sat)}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="strut" style="height:0.68333em;"></span><span class="strut bottom" style="height:1.03853em;vertical-align:-0.3551999999999999em;"></span><span class="base textstyle uncramped"><span class="mord"><span class="mord mathit" style="margin-right:0.22222em;">V</span><span class="vlist"><span style="top:0.18019999999999992em;margin-right:0.05em;margin-left:-0.22222em;"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span><span class="reset-textstyle scriptstyle cramped"><span class="mord scriptstyle cramped"><span class="mord mathit" style="margin-right:0.07153em;">C</span><span class="mord mathit" style="margin-right:0.05764em;">E</span><span class="mopen">(</span><span class="mord mathit">s</span><span class="mord mathit">a</span><span class="mord mathit">t</span><span class="mclose">)</span></span></span></span><span class="baseline-fix"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span>​</span></span></span></span></span></span> 随电压升高基本恒定</td></tr><tr><td>开关速度</td><td>极快（ns级）</td><td>较慢（μs级），有拖尾</td></tr><tr><td>适用电压</td><td>&lt;600V（优势区）</td><td>&gt;600V（优势区）</td></tr><tr><td>适用频率</td><td>&gt;50kHz</td><td>&lt;30kHz</td></tr></tbody></table><p><strong>关键理解</strong>：MOSFET在高压下的导通电阻与击穿电压的平方成正比（<span class="katex"><span class="katex-mathml"><math><semantics><mrow><msub><mi>R</mi><mrow><mi>D</mi><mi>S</mi><mo>(</mo><mi>o</mi><mi>n</mi><mo>)</mo></mrow></msub><mo>∝</mo><mi>B</mi><msubsup><mi>V</mi><mrow><mi>D</mi><mi>S</mi><mi>S</mi></mrow><mrow><mn>2</mn><mi mathvariant="normal">.</mi><mn>5</mn></mrow></msubsup></mrow><annotation encoding="application/x-tex">R_{DS(on)} \\propto BV_{DSS}^{2.5}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="strut" style="height:0.8141079999999999em;"></span><span class="strut bottom" style="height:1.1693079999999998em;vertical-align:-0.3551999999999999em;"></span><span class="base textstyle uncramped"><span class="mord"><span class="mord mathit" style="margin-right:0.00773em;">R</span><span class="vlist"><span style="top:0.18019999999999992em;margin-right:0.05em;margin-left:-0.00773em;"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span><span class="reset-textstyle scriptstyle cramped"><span class="mord scriptstyle cramped"><span class="mord mathit" style="margin-right:0.02778em;">D</span><span class="mord mathit" style="margin-right:0.05764em;">S</span><span class="mopen">(</span><span class="mord mathit">o</span><span class="mord mathit">n</span><span class="mclose">)</span></span></span></span><span class="baseline-fix"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span>​</span></span></span><span class="mrel">∝</span><span class="mord mathit" style="margin-right:0.05017em;">B</span><span class="mord"><span class="mord mathit" style="margin-right:0.22222em;">V</span><span class="vlist"><span style="top:0.275331em;margin-left:-0.22222em;margin-right:0.05em;"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span><span class="reset-textstyle scriptstyle cramped"><span class="mord scriptstyle cramped"><span class="mord mathit" style="margin-right:0.02778em;">D</span><span class="mord mathit" style="margin-right:0.05764em;">S</span><span class="mord mathit" style="margin-right:0.05764em;">S</span></span></span></span><span style="top:-0.363em;margin-right:0.05em;"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span><span class="reset-textstyle scriptstyle uncramped"><span class="mord scriptstyle uncramped"><span class="mord mathrm">2</span><span class="mord mathrm">.</span><span class="mord mathrm">5</span></span></span></span><span class="baseline-fix"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span>​</span></span></span></span></span></span>），而IGBT在高压下导通压降几乎不变。这就是为什么600V以上几乎都是IGBT的天下。</p><hr><h2 id="_4-🔬-技术原理-★★★★☆-📚🔧" tabindex="-1">4. 🔬 技术原理 ★★★★☆ 📚🔧 <a class="header-anchor" href="#_4-🔬-技术原理-★★★★☆-📚🔧" aria-label="Permalink to &quot;4. 🔬 技术原理 ★★★★☆ 📚🔧&quot;">​</a></h2><h3 id="_4-1-igbt结构演进" tabindex="-1">4.1 IGBT结构演进 <a class="header-anchor" href="#_4-1-igbt结构演进" aria-label="Permalink to &quot;4.1 IGBT结构演进&quot;">​</a></h3><h4 id="_4-1-1-基本结构-从mosfet到igbt" tabindex="-1">4.1.1 基本结构：从MOSFET到IGBT <a class="header-anchor" href="#_4-1-1-基本结构-从mosfet到igbt" aria-label="Permalink to &quot;4.1.1 基本结构：从MOSFET到IGBT&quot;">​</a></h4>',8)),p(n,{code:"flowchart%20TD%0A%20%20%20%20subgraph%20MOSFET%E7%BB%93%E6%9E%84%5B%22MOSFET%EF%BC%88VDMOS%EF%BC%89%E7%BB%93%E6%9E%84%22%5D%0A%20%20%20%20%20%20%20%20MS%5B%22Source%22%5D%20--%3E%20MP%5B%22P-body(%E6%B2%9F%E9%81%93)%22%5D%0A%20%20%20%20%20%20%20%20MP%20--%3E%20MN%5B%22N-%E6%BC%82%E7%A7%BB%E5%8C%BA(%E5%86%B3%E5%AE%9A%E8%80%90%E5%8E%8B)%22%5D%0A%20%20%20%20%20%20%20%20MN%20--%3E%20MD%5B%22N%2B%E8%A1%AC%E5%BA%95%20%E2%86%92%20Drain%22%5D%0A%20%20%20%20end%0A%20%20%20%20subgraph%20IGBT%E7%BB%93%E6%9E%84%5B%22IGBT%E5%9F%BA%E6%9C%AC%E7%BB%93%E6%9E%84%22%5D%0A%20%20%20%20%20%20%20%20IE%5B%22Emitter%22%5D%20--%3E%20IP%5B%22P-body(%E6%B2%9F%E9%81%93)%22%5D%0A%20%20%20%20%20%20%20%20IP%20--%3E%20IN%5B%22N-%E6%BC%82%E7%A7%BB%E5%8C%BA%22%5D%0A%20%20%20%20%20%20%20%20IN%20--%3E%20IC%5B%22P%2B%E9%9B%86%E7%94%B5%E5%8C%BA%20%E2%86%92%20Collector%22%5D%0A%20%20%20%20end%0A"}),s[5]||(s[5]=a("p",null,[a("strong",null,"核心差异"),t("：IGBT将MOSFET的N+漏极衬底替换为P+集电区，多了一个PN结 → 形成PNP晶体管。")],-1)),s[6]||(s[6]=a("h4",{id:"_4-1-2-npt-非穿通型-igbt",tabindex:"-1"},[t("4.1.2 NPT（非穿通型）IGBT "),a("a",{class:"header-anchor",href:"#_4-1-2-npt-非穿通型-igbt","aria-label":'Permalink to "4.1.2 NPT（非穿通型）IGBT"'},"​")],-1)),p(n,{code:"flowchart%20TD%0A%20%20%20%20E%5B%22Emitter%20N%2B%22%5D%20--%3E%20PB%5B%22P-base%20%E6%B2%9F%E9%81%93%22%5D%0A%20%20%20%20PB%20--%3E%20ND%5B%22N-drift%20%E5%8E%9A%2C%E4%BD%8E%E6%8E%BA%E6%9D%82%22%5D%0A%20%20%20%20ND%20--%3E%20NB%5B%22N-buffer%20%E5%8F%AF%E9%80%89%22%5D%0A%20%20%20%20NB%20--%3E%20PC%5B%22P%2B%20Collector%20%E9%80%8F%E6%98%8E%E9%9B%86%E7%94%B5%E6%9E%81%22%5D%0A"}),s[7]||(s[7]=a("h4",{id:"_4-1-3-fs-场截止型-igbt-★★★-现代主流",tabindex:"-1"},[t("4.1.3 FS（场截止型）IGBT ★★★ 现代主流 "),a("a",{class:"header-anchor",href:"#_4-1-3-fs-场截止型-igbt-★★★-现代主流","aria-label":'Permalink to "4.1.3 FS（场截止型）IGBT ★★★ 现代主流"'},"​")],-1)),p(n,{code:"flowchart%20TD%0A%20%20%20%20E%5B%22Emitter%20N%2B%22%5D%20--%3E%20PB%5B%22P-base%20%E6%B2%9F%E9%81%93%22%5D%0A%20%20%20%20PB%20--%3E%20ND%5B%22N-drift%20%E8%96%84%2C%E4%B8%AD%E6%8E%BA%E6%9D%82%22%5D%0A%20%20%20%20ND%20--%3E%20FS%5B%22N-Field%20Stop%E5%B1%82%20%E9%AB%98%E6%8E%BA%E6%9D%82%22%5D%0A%20%20%20%20FS%20--%3E%20PC%5B%22P%2B%20Collector%20%E9%AB%98%E6%B3%A8%E5%85%A5%E6%95%88%E7%8E%87%22%5D%0A"}),s[8]||(s[8]=e(`<h4 id="_4-1-4-igbt结构总结" tabindex="-1">4.1.4 IGBT结构总结 <a class="header-anchor" href="#_4-1-4-igbt结构总结" aria-label="Permalink to &quot;4.1.4 IGBT结构总结&quot;">​</a></h4><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>┌──────────────────────────────────────────────────────────────────┐</span></span>
...
<span class="line"><span>└──────────────────────────────────────────────────────────────────┘</span></span></code></pre></div><h3 id="_4-2-igbt静动态特性" tabindex="-1">4.2 IGBT静动态特性 <a class="header-anchor" href="#_4-2-igbt静动态特性" aria-label="Permalink to &quot;4.2 IGBT静动态特性&quot;">​</a></h3><h4 id="_4-2-1-输出特性-vs" tabindex="-1">4.2.1 输出特性（<span class="katex"><span class="katex-mathml"><math><semantics><mrow><msub><mi>I</mi><mi>C</mi></msub></mrow><annotation encoding="application/x-tex">I_C</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="strut" style="height:0.68333em;"></span><span class="strut bottom" style="height:0.83333em;vertical-align:-0.15em;"></span><span class="base textstyle uncramped"><span class="mord"><span class="mord mathit" style="margin-right:0.07847em;">I</span><span class="vlist"><span style="top:0.15em;margin-right:0.05em;margin-left:-0.07847em;"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span><span class="reset-textstyle scriptstyle cramped"><span class="mord mathit" style="margin-right:0.07153em;">C</span></span></span><span class="baseline-fix"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span>​</span></span></span></span></span></span> vs <span class="katex"><span class="katex-mathml"><math><semantics><mrow><msub><mi>V</mi><mrow><mi>C</mi><mi>E</mi></mrow></msub></mrow><annotation encoding="application/x-tex">V_{CE}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="strut" style="height:0.68333em;"></span><span class="strut bottom" style="height:0.83333em;vertical-align:-0.15em;"></span><span class="base textstyle uncramped"><span class="mord"><span class="mord mathit" style="margin-right:0.22222em;">V</span><span class="vlist"><span style="top:0.15em;margin-right:0.05em;margin-left:-0.22222em;"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span><span class="reset-textstyle scriptstyle cramped"><span class="mord scriptstyle cramped"><span class="mord mathit" style="margin-right:0.07153em;">C</span><span class="mord mathit" style="margin-right:0.05764em;">E</span></span></span></span><span class="baseline-fix"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span>​</span></span></span></span></span></span>） <a class="header-anchor" href="#_4-2-1-输出特性-vs" aria-label="Permalink to &quot;4.2.1 输出特性（$I_C$ vs $V_{CE}$）&quot;">​</a></h4><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>典型的FS IGBT输出特性曲线：</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>   - Tj最终=95°C ✅（留有55°C余量）</span></span></code></pre></div><p><strong>经验总结</strong>：</p><ol><li>600V以上功率开关优先考虑IGBT，不要把低压MOSFET的经验照搬</li><li>MOSFET的<span class="katex"><span class="katex-mathml"><math><semantics><mrow><msub><mi>R</mi><mrow><mi>D</mi><mi>S</mi><mo>(</mo><mi>o</mi><mi>n</mi><mo>)</mo></mrow></msub></mrow><annotation encoding="application/x-tex">R_{DS(on)}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="strut" style="height:0.68333em;"></span><span class="strut bottom" style="height:1.03853em;vertical-align:-0.3551999999999999em;"></span><span class="base textstyle uncramped"><span class="mord"><span class="mord mathit" style="margin-right:0.00773em;">R</span><span class="vlist"><span style="top:0.18019999999999992em;margin-right:0.05em;margin-left:-0.00773em;"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span><span class="reset-textstyle scriptstyle cramped"><span class="mord scriptstyle cramped"><span class="mord mathit" style="margin-right:0.02778em;">D</span><span class="mord mathit" style="margin-right:0.05764em;">S</span><span class="mopen">(</span><span class="mord mathit">o</span><span class="mord mathit">n</span><span class="mclose">)</span></span></span></span><span class="baseline-fix"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span>​</span></span></span></span></span></span>正温度系数很剧烈（2~3倍），查数据表要看125°C的值</li><li>IGBT数据表的<span class="katex"><span class="katex-mathml"><math><semantics><mrow><msub><mi>V</mi><mrow><mi>C</mi><mi>E</mi><mo>(</mo><mi>s</mi><mi>a</mi><mi>t</mi><mo>)</mo></mrow></msub></mrow><annotation encoding="application/x-tex">V_{CE(sat)}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="strut" style="height:0.68333em;"></span><span class="strut bottom" style="height:1.03853em;vertical-align:-0.3551999999999999em;"></span><span class="base textstyle uncramped"><span class="mord"><span class="mord mathit" style="margin-right:0.22222em;">V</span><span class="vlist"><span style="top:0.18019999999999992em;margin-right:0.05em;margin-left:-0.22222em;"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span><span class="reset-textstyle scriptstyle cramped"><span class="mord scriptstyle cramped"><span class="mord mathit" style="margin-right:0.07153em;">C</span><span class="mord mathit" style="margin-right:0.05764em;">E</span><span class="mopen">(</span><span class="mord mathit">s</span><span class="mord mathit">a</span><span class="mord mathit">t</span><span class="mclose">)</span></span></span></span><span class="baseline-fix"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span>​</span></span></span></span></span></span>同样要看高温值</li></ol><hr><h3 id="案例2-16khz-igbt开关频率导致热失控" tabindex="-1">案例2：16kHz IGBT开关频率导致热失控 <a class="header-anchor" href="#案例2-16khz-igbt开关频率导致热失控" aria-label="Permalink to &quot;案例2：16kHz IGBT开关频率导致热失控&quot;">​</a></h3><p><strong>项目背景</strong>：</p><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>应用：注塑机伺服（11kW）</span></span>
...
<span class="line"><span>   结论：选型必须考虑具体工作点，不能一概而论</span></span></code></pre></div><h3 id="练习5-判断题" tabindex="-1">练习5：判断题 <a class="header-anchor" href="#练习5-判断题" aria-label="Permalink to &quot;练习5：判断题&quot;">​</a></h3><p><strong>题目1</strong>：IGBT在600V以上比MOSFET导通损耗更低的根本原因是：（ ）</p><ul><li>A. IGBT的开关速度更快 B. IGBT的Vce(sat)基本不随电压升高而增大 C. IGBT的栅极驱动更简单 D. IGBT没有拖尾电流</li></ul><blockquote><p>答案：B。MOSFET的<span class="katex"><span class="katex-mathml"><math><semantics><mrow><msub><mi>R</mi><mrow><mi>D</mi><mi>S</mi><mo>(</mo><mi>o</mi><mi>n</mi><mo>)</mo></mrow></msub></mrow><annotation encoding="application/x-tex">R_{DS(on)}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="strut" style="height:0.68333em;"></span><span class="strut bottom" style="height:1.03853em;vertical-align:-0.3551999999999999em;"></span><span class="base textstyle uncramped"><span class="mord"><span class="mord mathit" style="margin-right:0.00773em;">R</span><span class="vlist"><span style="top:0.18019999999999992em;margin-right:0.05em;margin-left:-0.00773em;"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span><span class="reset-textstyle scriptstyle cramped"><span class="mord scriptstyle cramped"><span class="mord mathit" style="margin-right:0.02778em;">D</span><span class="mord mathit" style="margin-right:0.05764em;">S</span><span class="mopen">(</span><span class="mord mathit">o</span><span class="mord mathit">n</span><span class="mclose">)</span></span></span></span><span class="baseline-fix"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span>​</span></span></span></span></span></span>随耐压升高呈指数增长，而IGBT的<span class="katex"><span class="katex-mathml"><math><semantics><mrow><msub><mi>V</mi><mrow><mi>C</mi><mi>E</mi><mo>(</mo><mi>s</mi><mi>a</mi><mi>t</mi><mo>)</mo></mrow></msub></mrow><annotation encoding="application/x-tex">V_{CE(sat)}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="strut" style="height:0.68333em;"></span><span class="strut bottom" style="height:1.03853em;vertical-align:-0.3551999999999999em;"></span><span class="base textstyle uncramped"><span class="mord"><span class="mord mathit" style="margin-right:0.22222em;">V</span><span class="vlist"><span style="top:0.18019999999999992em;margin-right:0.05em;margin-left:-0.22222em;"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span><span class="reset-textstyle scriptstyle cramped"><span class="mord scriptstyle cramped"><span class="mord mathit" style="margin-right:0.07153em;">C</span><span class="mord mathit" style="margin-right:0.05764em;">E</span><span class="mopen">(</span><span class="mord mathit">s</span><span class="mord mathit">a</span><span class="mord mathit">t</span><span class="mclose">)</span></span></span></span><span class="baseline-fix"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span>​</span></span></span></span></span></span>相对恒定。</p></blockquote><p><strong>题目2</strong>：拖尾电流对系统的主要影响是：（ ）</p><ul><li>A. 增加导通损耗 B. 增加关断损耗 C. 缩短死区时间 D. 提高开关频率</li></ul><blockquote><p>答案：B。拖尾电流期间<span class="katex"><span class="katex-mathml"><math><semantics><mrow><msub><mi>V</mi><mrow><mi>C</mi><mi>E</mi></mrow></msub></mrow><annotation encoding="application/x-tex">V_{CE}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="strut" style="height:0.68333em;"></span><span class="strut bottom" style="height:0.83333em;vertical-align:-0.15em;"></span><span class="base textstyle uncramped"><span class="mord"><span class="mord mathit" style="margin-right:0.22222em;">V</span><span class="vlist"><span style="top:0.15em;margin-right:0.05em;margin-left:-0.22222em;"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span><span class="reset-textstyle scriptstyle cramped"><span class="mord scriptstyle cramped"><span class="mord mathit" style="margin-right:0.07153em;">C</span><span class="mord mathit" style="margin-right:0.05764em;">E</span></span></span></span><span class="baseline-fix"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span>​</span></span></span></span></span></span>已经升高，<span class="katex"><span class="katex-mathml"><math><semantics><mrow><msub><mi>I</mi><mi>C</mi></msub><mo>×</mo><msub><mi>V</mi><mrow><mi>C</mi><mi>E</mi></mrow></msub></mrow><annotation encoding="application/x-tex">I_C \\times V_{CE}</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="strut" style="height:0.68333em;"></span><span class="strut bottom" style="height:0.83333em;vertical-align:-0.15em;"></span><span class="base textstyle uncramped"><span class="mord"><span class="mord mathit" style="margin-right:0.07847em;">I</span><span class="vlist"><span style="top:0.15em;margin-right:0.05em;margin-left:-0.07847em;"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span><span class="reset-textstyle scriptstyle cramped"><span class="mord mathit" style="margin-right:0.07153em;">C</span></span></span><span class="baseline-fix"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span>​</span></span></span><span class="mbin">×</span><span class="mord"><span class="mord mathit" style="margin-right:0.22222em;">V</span><span class="vlist"><span style="top:0.15em;margin-right:0.05em;margin-left:-0.22222em;"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span><span class="reset-textstyle scriptstyle cramped"><span class="mord scriptstyle cramped"><span class="mord mathit" style="margin-right:0.07153em;">C</span><span class="mord mathit" style="margin-right:0.05764em;">E</span></span></span></span><span class="baseline-fix"><span class="fontsize-ensurer reset-size5 size5"><span style="font-size:0em;">​</span></span>​</span></span></span></span></span></span>产生大量关断损耗。</p></blockquote><p><strong>题目3</strong>：FS IGBT相比NPT IGBT的主要优势是：（ ）</p><ul><li>A. 更高耐压 B. 更低的Vce(sat) C. 更快的开关速度 D. 更好的并联特性</li></ul><blockquote><p>答案：B。FS IGBT通过Field Stop层大幅减薄N-drift区厚度，导通压降从3V降至1.8V。</p></blockquote><p><strong>题目4</strong>：SiC MOSFET相比Si IGBT在电机驱动中的最大优势是：（ ）</p><ul><li>A. 成本更低 B. 栅极驱动更简单 C. 可在更高频下工作（低E_off） D. 短路耐受更强</li></ul><blockquote><p>答案：C。SiC MOSFET无拖尾电流，E_off极小，可在&gt;50kHz下高效工作。</p></blockquote><p><strong>题目5</strong>：IGBT死区时间通常设为4μs，而MOSFET只需1μs，主要原因是：（ ）</p><ul><li>A. IGBT栅极电荷更大 B. IGBT关断有拖尾电流 C. IGBT导通更快 D. IGBT驱动电压更高</li></ul><blockquote><p>答案：B。拖尾电流导致IGBT关断需要更长时间才能确保电流完全归零。</p></blockquote><hr><h2 id="附录-快速计算公式汇总" tabindex="-1">附录：快速计算公式汇总 <a class="header-anchor" href="#附录-快速计算公式汇总" aria-label="Permalink to &quot;附录：快速计算公式汇总&quot;">​</a></h2><h3 id="a-igbt损耗" tabindex="-1">A. IGBT损耗 <a class="header-anchor" href="#a-igbt损耗" aria-label="Permalink to &quot;A. IGBT损耗&quot;">​</a></h3><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>P_cond = Ic × Vce(sat) × D</span></span>
<span class="line"><span>P_sw = (E_on + E_off) × f_sw</span></span>
