...
3. [控制理论](/content/motor/control-theory/CT-01-Open-Loop-Closed-Loop.html)：建立闭环、频域和状态空间语言。
...
6. [仿真与调试](/content/motor/simulation/SIM-00-C-Simulation-Overview.html)：把算法放进 C 仿真与验证流程。
